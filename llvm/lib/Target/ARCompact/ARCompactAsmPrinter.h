...
public:
  ...
  void printMemOperand(const MachineInstr *MI, unsigned opNum, raw_ostream &OS,
     const char *Modifier = 0);
  void printCCOperand(const MachineInstr *MI, unsigned OpNum, raw_ostream &O);
  void printPredicateOperand(const MachineInstr *MI, unsigned OpNum,
      raw_ostream &O);
